 ...
 */
export function editor_init(cols: number, rows: number): string;
 ...
 */
export function editor_resize(cols: number, rows: number): string;
 ...
 * Returns VT bytes to write to xterm.js.
 */
export function editor_step(input: string): string;
